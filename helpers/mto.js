...
function getMTOPointLayer(url, callback) {
  request({ uri: url }, function (error, response, body) {
    ...
    if (url.toUpperCase().indexOf("CAMERA") != -1) {
      ...
      // DURHAM
      mto.push({ Description: "Highway 48 and Simcoe Street", Latitude: 44.4252, Longitude: -79.1226, Url: "https://apps.durham.ca/Applications/Traffic/TrafficWatch/TrafficWatchData/10152339.jpg" });
    }
